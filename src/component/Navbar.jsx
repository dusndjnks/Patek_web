...
const Navbar = () => {
  ...
  return (
    <div className={`lg:text-3xl md:text-xl  text-lg text-gray-800 flex pt-5  items-start duration-500 justify-between lg:px-40 md:px-10  s:px-10 sm:px-5 px-4 lg:h-24 relative  bg-gray-300 ${extendNavbar ? "h-48" : "h-24"}`}>
        <div className='flex'>
      ...
      <div className={`lg:space-x-5 md:space-x-2  items-end  duration-500 absolute md:static space-x-1 md:flex-row flex flex-col ${extendNavbar ? "right-10  top-16" : "top-[-200px] "}`}>
      ...
      <div className={`md:hidden pt-3 pr-5 `} onClick={ () => {setExtendNavbar(open => !open)}}>
          {
